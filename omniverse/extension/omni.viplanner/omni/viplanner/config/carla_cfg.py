...
LIMO_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path="/home/recklessdriver/projects/Models/caonima.usd",
...
class TerrainSceneCfg(InteractiveSceneCfg):
    ...
    height_scanner = RayCasterCfg(
        prim_path="{ENV_REGEX_NS}/Robot/limo/chassis_link/base",
    ...
    depth_camera = CameraCfg(
        prim_path="{ENV_REGEX_NS}/Robot/limo/chassis_link/base/depth_camera",
    ...
    semantic_camera = CameraCfg(
        prim_path="{ENV_REGEX_NS}/Robot/limo/chassis_link/base/semantic_camera",
        offset=CameraCfg.OffsetCfg(
            pos=(0.51, 0.0, 0.1),
            rot=(-0.5, 0.5, -0.5, 0.5),
        ),
...
class ViPlannerCarlaCfg(ViPlannerBaseCfg):
    ...
    def __post_init__(self):
        ...
        self.viewer.eye = (329, 332, 8)
        self.viewer.lookat = (329, 332, 0)

        self.scene.robot.init_state.pos = (329, 332, 0.8)
